...
public class CommonConstants {
    ...
    public final static String WINDOWS_SCORE_FILE_PATH = "src/main/java/fun/redamancyxun/chinese/backend/score/";
...
//    public final static String LINUX_SCORE_FILE_PATH =  "src/main/java/fun/redamancyxun/chinese/backend/score/";
    public final static String WINDOWS_PYTHON_PATH = "D:\\用户\\桌面\\国际中文朗读语料评分模型建构与优化实践\\模型训练\\训练工具\\训练数据处理\\.venv\\Scripts\\python.exe";
    public final static String LINUX_PYTHON_PATH = "/python/venv/bin/python3";
//    public final static String LINUX_PYTHON_PATH = "D:\\用户\\桌面\\国际中文朗读语料评分模型建构与优化实践\\模型训练\\训练工具\\训练数据处理\\.venv\\Scripts\\python.exe";
