package fun.redamancyxun.chinese.backend.util;
...
import static fun.redamancyxun.chinese.backend.common.CommonConstants.IMAGE_PATH;
import static fun.redamancyxun.chinese.backend.common.CommonConstants.USER_FILE_PATH;
